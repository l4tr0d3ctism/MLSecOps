...
- `AML.T0110` AI Agent Tool Poisoning (ungoverned MCP / IDE plugins)
...
- [Evidence Pack](#what-is-an-evidence-pack)
...
- ISO/IEC 42001
- ISO/IEC 23894
- EU AI Act - formal compliance frameworks cited in section note
...
- [Chapter 2 threat modeling](02-scope-risk-threat-model.md) (Chapter 2)
...
**Implementation guidance (this guide)**
- [Lifecycle control points 4, 8](06-pipeline.md#lifecycle-control-points) (Chapter 6)
- [Policy examples in Chapter 12](12-threat-control-tools-map.md#l4--policy-as-code-opa--conftest)
...
**Implementation guidance (this guide)**
- [Personas and shared responsibility](#personas-and-shared-responsibility)
- [Release decision model](06-pipeline.md#release-decision-model) (Chapter 6)
...
**Implementation guidance (this guide)**
- [Model signing](05-model-artifact-supply-chain.md) (Chapter 5)
- [Evidence Pack](#what-is-an-evidence-pack)
...
**Implementation guidance (this guide)**
- [Red Team program and security test cadence](06-pipeline.md#red-team-program-and-security-test-cadence) (Chapter 6)
...
**Implementation guidance (this guide)**
- [Security validation and assurance](#security-validation-and-assurance)
- [Governance Benchmark Suite](#governance-benchmark-suite)
...
**Frameworks and standards**
- OWASP AI Exchange: [Continuous validation](https://owaspai.org/go/continuousvalidation/)
- [AI security testing overview](https://owaspai.org/go/testing/)
...
**Implementation guidance (this guide)**
- [Threat model](02-scope-risk-threat-model.md) (Chapter 2)
...
**Frameworks and standards**
- ISO/IEC 42001
- EU AI Act high-risk documentation themes (see [Relationship to compliance](#relationship-to-compliance))
