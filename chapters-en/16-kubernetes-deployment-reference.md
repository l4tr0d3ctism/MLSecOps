...
- [Multi-tenant RAG](07-llm-rag-security.md#multi-tenant-rag) (Chapter 7)
...
**Implementation guidance (this guide)**
- [Advanced Multi-Tenant hardening](07-llm-rag-security.md#advanced-multi-tenant-hardening) (Chapter 7)
- [SOC integration](10-monitoring-soc-ir.md#soc-integration) (Chapter 10)
...
- OpenSSF SLSA / Sigstore supply-chain practice

**Implementation guidance (this guide)**
- [Provenance and signing](05-model-artifact-supply-chain.md#provenance-and-signing) (Chapter 5)
- [Lifecycle control point 9](06-pipeline.md#lifecycle-control-points) (Chapter 6)
...
- [PR #937 - multi-tenant API keys](https://github.com/vllm-project/production-stack/pull/937)

**Implementation guidance (this guide)**
- [LeftoverLocals case study](13-case-studies.md#leftoverlocals-cve-2023-4969--documented-incident) (Chapter 13)
- [GPU isolation](#gpu-isolation-and-shared-inference) (this chapter)
...
**Implementation guidance (this guide)**
- [Secure deployment methods for retrained models](06-pipeline.md#secure-deployment-methods-for-retrained-models) (Chapter 6)
- [AI Compute Hijacking](03-threat-landscape.md#ai-compute-hijacking-demonstrated--active-patterns) (Chapter 3)
...
**Frameworks and standards**
- MITRE ATLAS: runtime and infrastructure techniques (map in SOC playbooks); Falco, Tetragon/eBPF, KubeArmor, Cilium Hubble - upstream project docs

**Implementation guidance (this guide)**
- [Detection Engineering](10-monitoring-soc-ir.md#detection-engineering) (Chapter 10)
...
- [Data required for telemetry](10-monitoring-soc-ir.md#data-required-for-telemetry) (Chapter 10)
...
- [Appendix: Informative tool command reference](12-threat-control-tools-map.md#appendix-informative-tool-command-reference) (Chapter 12)
...
**Implementation guidance (this guide)**
- [Level 2: Operational](14-maturity-roadmap.md#level-2-operational) (Chapter 14)
- [Minimum baseline checklist](#minimum-baseline-checklist-level-2-production) items above
